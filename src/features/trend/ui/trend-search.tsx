...
export const TrendSearch = () => {
    ...
    return (
        <div 
            ...
            className={
                twMerge(
                    "relative transition-all duration-500 text-black flex flex-1 flex-row gap-5 items-center max-w-250 rounded-full bg-gray-100 py-4 pl-29 pr-12 dark:bg-[#222] dark:text-white min-2xl:max-w-480",
